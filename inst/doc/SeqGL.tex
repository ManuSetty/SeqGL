...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: invalid class "{}IRanges"{} object: 'widths(x)' cannot contain negative values}}\begin{alltt}
...
## [1] "Time for extracting sequences: 0.63 minutes"
...
## [1] "Time for determining features : 1.65"
## [1] "Selecting top features..."
## [1] "Time for selecting features: 0.40 minutes"
## [1] "Package and return..."
## [1] "Total time for constructing data: 2.72 minutes"
\end{verbatim}
\begin{alltt}
...
## [1] "Time for running clustering: 2.42 minutes"
\end{verbatim}
\begin{alltt}
...
## [1] "i: 5 of 5, j: 4 of 5"
## [1] "i: 5 of 5, j: 5 of 5"
## [1] "Time for running crossvalidation: 1.83 minutes"
\end{verbatim}
\begin{alltt}
...
## [1] "Time for running group lasso: 0.10 minutes"
\end{verbatim}
\end{kframe}
\end{knitrout}
